...
public class SeafoodActivity extends AppCompatActivity {
    private GroupAdapter groupAdapter;
    private List<Ingredient> ingredients = new ArrayList<>();
    private RecyclerView rvSeafoodItems;
    ...
    private void displayRecyclerView() {
        rvSeafoodItems = findViewById(R.id.rvSeafoodItems);
        groupAdapter = new GroupAdapter(ingredients);
        rvSeafoodItems.setAdapter(groupAdapter);
        rvSeafoodItems.setLayoutManager(new LinearLayoutManager(this));
    }

    private void getSeafoodGroup() {
        ParseQuery<Group> group = ParseQuery.getQuery(Group.class);
        group.whereEqualTo(Group.KEY_group_name, "Seafood");
