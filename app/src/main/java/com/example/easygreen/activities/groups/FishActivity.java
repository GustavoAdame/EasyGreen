...
public class FishActivity extends AppCompatActivity {
    ...
    private RecyclerView rvFishItems;
    ...
    private void displayRecyclerView() {
        rvFishItems = findViewById(R.id.rvFishItems);
        groupAdapter = new GroupAdapter(ingredients);
        rvFishItems.setAdapter(groupAdapter);
        rvFishItems.setLayoutManager(new LinearLayoutManager(this));
    }

    private void getFishGroup() {
        ParseQuery<Group> group = ParseQuery.getQuery(Group.class);
        group.whereEqualTo(Group.KEY_group_name, "Fish");
